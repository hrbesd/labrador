...
{   
    ...
    Expression gongGaoChildUrlExpression;
    Expression gongGaoChildTitleExpression;
    gongGaoChildUrlExpression.label = "url";
    gongGaoChildUrlExpression.value = "<a .*href=\"([^\"]*)\" class=\"bgc1\" onmouseover=\"this.className=\'bgc2\'\" onmouseout=\"this.className=\'bgc1\'";
    gongGaoChildTitleExpression.label = "title";
    gongGaoChildTitleExpression.value = "class=\"bgc1\" onmouseover=\"this.className='bgc2'\" .*<span>(.*)</span>";

    gongGaoChildRule->expressionList<<gongGaoChildUrlExpression<<gongGaoChildTitleExpression;

    Expression gongGaoArticleUrlExpression;
    Expression gongGaoArticleTitleExpression;
    gongGaoArticleRule->nextPageExpression.value = "<a href=\"([^\"]*)\" class=\"Next\">下页";
    gongGaoArticleUrlExpression.label = "url";
    gongGaoArticleUrlExpression.value = "<a class=\"f3348\" href=\"([^\"]*)\"";
    gongGaoArticleTitleExpression.label = "title";
    gongGaoArticleTitleExpression.value = "<a class=\"f3348\".*title=\"([^\"]*)\"";

    gongGaoArticleRule->expressionList<<gongGaoArticleUrlExpression<<gongGaoArticleTitleExpression;
